...
import { FlatList, FlatListProps, StyleProp, ViewStyle, StyleSheet } from 'react-native';
...
export function AppGrid<ItemT>({
  ...
  const resolvedContentContainerStyle = useMemo<StyleProp<ViewStyle>>(
    () => [
      ...
      hasData ? null : [styles.emptyContentContainer, AppStyles.j_center, AppStyles.a_center, { flexGrow: 1 }],
      contentContainerStyle,
    ],
