  ...
  (
    ...
    const getContainerStyle = (): ViewStyle => {
      const baseStyle = variant === 'outlined'
        ? { ...styles.inputContainerOutlined, ...AppStyles.f_Row, ...AppStyles.a_center }
        : { ...styles.inputContainerFilled, ...AppStyles.f_Row, ...AppStyles.a_center };
    ...
    return (
      <View style={[styles.container, containerStyle]}>
        ...
        <View style={[getContainerStyle(), inputContainerStyle]}>
          {leftIcon && (
            <View style={[styles.leftIconContainer, AppStyles.a_center, AppStyles.j_center]}>
              {leftIcon}
            </View>
          )}
          ...
          <TextInput
            ...
            style={[
              ...
              (showClearButton || showPasswordButton || rightIcon) ? styles.inputWithRightIcon : undefined,
              style,
            ]}
            {...rest}
          />

          <View style={[styles.rightContainer, AppStyles.a_center, AppStyles.j_center]}>
            {showClearButton && (
              <TouchableOpacity
                onPress={handleClear}
                style={[styles.iconButton, AppStyles.a_center, AppStyles.j_center]}
        ...
        {(helperText || error || showCounter) && (
          <View style={[styles.bottomContainer, AppStyles.a_center, AppStyles.j_center]}>
